...
if($params->get('environment', 'live')) {
    ...
    define('AUTHORIZATION_ENDPOINT', 'https://sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/authorize');
    define('ACCESS_TOKEN_ENDPOINT', 'https://sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/tokenservice');
    define('PROFILE_ENDPOINT', 'https://sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/userinfo');
    define('LOGOUT_ENDPOINT', 'https://sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/endsession');
    define('VALIDATE_ENDPOINT', 'https://sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/checkid');
}
...
class PayPalAccess{
    ...
    * 
    */
    public function __construct($key = null, $secret = null, $scopes = null, $return_url = null){
        if(!empty($key)) $this->key = $key;
        if(!empty($secret)) $this->secret = $secret;
        if(!empty($scopes)) $this->scopes = $scopes;
